...
File based on : https://github.com/carpedm20/DCGAN-tensorflow/blob/master/model.py
...
class DCGAN(object):
    ...
    def train(self, config):
        ...
        sample_z=np.random.randn(self.sample_size,self.z_dim)
        if config.dataset == 'mnist':
    ...
    def discriminator(self, image, y=None, reuse=False, is_train=True):
        if reuse:
